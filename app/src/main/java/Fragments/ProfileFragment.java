...
public class ProfileFragment extends Fragment {
    ...
    private void updatePostalCode() {
        if (!postalCode_et.getText().toString().trim().equals(postalCode)) {
            ...
            myUID.child("AddressCode").setValue(postalCode);
        }
    }
                        ...
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                if (user != null) {
                                    ...
                                    myUID.child("ImageURL").setValue(u.toString());
                                }
    ...
    public void setAuthStateListener(View view) {
        ...
        postalCode_et = (TextView) view.findViewById(R.id.profile_address);
                ...
                if (authRef.getCurrentUser() != null) {
                    ...
                    myUID.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            postalCode = dataSnapshot.child("AddressCode").getValue(String.class);
